...
class RecipeViewSet(ModelViewSet):
    ...
    def favorite(self, request, **kwargs):
        ...
        if request.method == 'POST':
            return self.add_favorites(Favorite, request, recipe)
        return self.delete_favorites(Favorite, request, recipe)
    ...
    def shopping_cart(self, request, **kwargs):
        if request.method == 'POST':
            return self.add_favorites(ShoppingCart, request, kwargs.get('pk'))
        return self.delete_favorites(ShoppingCart, request, kwargs.get('pk'))
